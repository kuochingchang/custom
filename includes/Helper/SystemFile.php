...
class SystemFile
{
    ...
    public function getPlugins()
    {
        if (empty($this->plugins)) {
            // 已启用插件
            $this->activatedPlugins = CustomPlugin::export();
            // 插件目录列表
            $pluginsDir = glob(CUSTOM_ROOT_PATH . 'content/plugins/*/');
    ...
    public function getThemes()
    {
        if (empty($this->themes)) {
            ...
            // 主题目录列表
            $themesDir = glob(CUSTOM_ROOT_PATH . 'content/themes/*/');
            ...
            $themesInfo = array_map(function ($themesDir) {
                ...
                // 修改启用状态
                $themeInfo['is_activated'] = $themeInfo['dir'] === $this->theme;
